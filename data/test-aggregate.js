...
console.log("loaded test-aggregate.js");

/*
self.port.on("connection", function(connection) {
  console.log("got a connection in test-aggregate");
});
*/
...
self.port.on('init', function(lightbeamToken) {
  console.log("got init in test-aggregate.js");
});
...
self.port.on('filter', applyFilter);
...
function onConnection(conn){
    console.log("got onconnection in test-aggregate");
...
self.port.on('connection', onConnection);
