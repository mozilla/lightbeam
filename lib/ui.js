...
function attachToLightbeamPage(worker) {
    ...
    var onRestored = function() {
        ...
        console.log('Connection received restored');
    ...
    var onUIReady = function() {
        console.log('addon received uiready');
    ...
    function onUpload(data) {
      ...
      var uploadServer = 'https://data.mozilla.com/submit/lightbeam';
      var request = Request({
        url: uploadServer,
    ...
    function onWorkerDetach() {
        ...
        this.port.removeListener("upload", onUpload);
        uiworker = null;
        this.destroy();
    }
    ...
    try {
        ...
        worker.port.on("upload", onUpload);
    } catch (e) {
