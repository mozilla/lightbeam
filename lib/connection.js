...
Connection.prototype.restoreFromSubject = function(subject){
    ...
    var sourceVisited = browserUri && (browserUri.equals(target) || browserUri.spec === 'about:blank') && !isAjax;
   ...
   if (target.host === 'localhost' || source.host === 'localhost'){
    ...
    if (!tab){
        this.valid = false;
        this.message = 'No tab found for request: ' + target.spec;
        Connection.log(this.message);
        return this;
    }
