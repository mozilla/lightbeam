d3 = function () {
  ...
  function vt(n, t, e, r) {
    ...
    var u = {}, a = ya.dispatch("progress", "load", "error"),
  ...
  ya.touches = function (n, t) {
    ...
    function n() {
      this.on(w, o).on(Ja + ".zoom", l).on(S, s).on("dblclick.zoom", f).on("touchstart.zoom", c)
    }
    ...
    function u() {
      d && d.domain(p.range().map(function (n) {
        return (n - x[0]) / b
      }).map(p.invert)), y && y.domain(v.range().map(function (n) {
        return (n - x[1]) / b
      }).map(v.invert))
    }
    ...
    function c() {
      function n() {
        var n = ya.touches(u),
          ...
          e = s[t.identifier];
        if (o = n[1]) {
          var o, l = s[o.identifier],
            g = ya.event.scale;
          if (null == g) {
            var p = (p = o[0] - t[0]) * p + (p = o[1] - t[1]) * p;
            g = f && Math.sqrt(p / f)
          }
          t = [(t[0] + o[0]) / 2, (t[1] + o[1]) / 2], e = [(e[0] + l[0]) / 2, (e[1] + l[1]) / 2], r(g * h)
        }
        M = null, i(t, e), a(c)
      }

      function e() {
        y.on(d, null).on(v, null), x.on(w, o), _()
      }
      var u = this,
        c = k.of(u, arguments),
        l = ya.touches(u),
        ...
        h = b,
        p = Date.now(),
        m = "zoom-" + ya.event.changedTouches[0].identifier,
        d = "touchmove." + m,
        v = "touchend." + m,
        y = ya.select(ba).on(d, n).on(v, e),
        x = ya.select(u).on(w, null),
        _ = H();
    ...
    function l() {
      g(), h || (h = t(ya.mouse(this))), r(Math.pow(2, .002 * $a()) * b), i(ya.mouse(this), h), a(k.of(this, arguments))
    }
    ...
    function f() {
      ...
      r(Math.pow(2, ya.event.shiftKey ? Math.ceil(u) - 1 : Math.floor(u) + 1)), i(n, e), a(k.of(this, arguments))
    }
    ...
    return n.translate = function (t) {
      ...
      return arguments.length ? (d = t, p = t.copy(), x = [0, 0], b = 1, n) : d
    }, n.y = function (t) {
      return arguments.length ? (y = t, v = t.copy(), x = [0, 0], b = 1, n) : y
    }, ya.rebind(n, k, "on")
  };
  var $a, Wa = [0, 1 / 0],
  ...
  var yo = ".",
    ...
    xo = [3, 3],
    bo = "$",
    _o = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"].map(wt);
  ...
  pc.area = function () {
    ...
    function t(n) {
      ...
      if (c === Ie && l === Ve) t = n;
        ...
        for (t = new Array(s), a = 0; s > a; ++a) t[a] = [+c.call(this, u = n[a], a), +l.call(this, u, a)]; if (mr(t, function (n) {
        var t, e, r, i, u, a;
  ...
  var dc = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g;
  ya.interpolate = Sr, ya.interpolators = [
    function (n, t) {
      var e = typeof t;
  ...
  ya.interpolateTransform = Br, ya.layout = {}, ya.layout.bundle = function () {
    ...
    var e, r, i, u, a, o = {}, c = ya.dispatch("start", "tick", "end"),
      l = [1, 1],
      s = .9,
      f = bc,
      h = _c,
    ...
    return o.tick = function () {
      ...
      if (i = [], "function" == typeof f)
        ...
        for (e = 0; m > e; ++e) i[e] = f; if (u = [], "function" == typeof h)
        for (e = 0; m > e; ++e) u[e] = +h.call(this, v[e], e);
      else
        for (e = 0; m > e; ++e) u[e] = h; if (a = [], "function" == typeof g)
  ...
  var _l = yl.map(function (n) {
    ...
    wl = [
      ...
      [ya.time.format.utc("%B"),
        function (n) {
          return n.getUTCMonth()
        }
      ],
      [ya.time.format.utc("%b %d"),
        function (n) {
          return 1 != n.getUTCDate()
        }
      ],
      [ya.time.format.utc("%a %d"),
        function (n) {
          return n.getUTCDay() && 1 != n.getUTCDate()
        }
      ],
      [ya.time.format.utc("%I %p"),
        function (n) {
          return n.getUTCHours()
        }
      ],
      [ya.time.format.utc("%I:%M"),
        function (n) {
          return n.getUTCMinutes()
        }
      ],
      [ya.time.format.utc(":%S"),
        function (n) {
          return n.getUTCSeconds()
        }
      ],
      [ya.time.format.utc(".%L"),
        function (n) {
